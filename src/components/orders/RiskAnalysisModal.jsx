...
export function RiskAnalysisModal({ isOpen, onClose, data }) {
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			{/* Modal Content */}
			<div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto z-10 m-4 animate-in fade-in zoom-in duration-200">
				{/* Close Button */}
				<button onClick={onClose} className="absolute top-4 right-4 p-2 text-gray-400 hover:text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:bg-gray-700 rounded-full transition-colors">
				...
				<div className="p-6">
					...
					<div className="flex flex-col items-center justify-center mb-8">
						<div className="flex items-center gap-2 text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">
						...
						<div className="w-full max-w-md">
							<div className="relative h-2 rounded-full w-full bg-gradient-to-r from-green-500 via-yellow-400 to-red-600">
                                {/* Indicator */}
                                <div 
                                    className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-white dark:bg-gray-800 border-2 border-gray-600 rounded-full shadow transform transition-all duration-500"
						...
						<p className="text-center text-gray-600 dark:text-gray-400 mt-6 max-w-lg">
					...
					<div className="flex flex-col gap-8">
						{/* Customer Details */}
						<div>
							<h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4 border-b pb-2 flex items-center gap-2">
							...
							<div className="space-y-4">
								<div className="grid grid-cols-[1fr,1.5fr] gap-2">
									...
									<span className="text-gray-900 dark:text-gray-100 text-sm break-all">{customer.email}</span>
								</div>
								<div className="grid grid-cols-[1fr,1.5fr] gap-2">
									<div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
									...
									<span className="text-gray-900 dark:text-gray-100 text-sm">{customer.name}</span>
								</div>
								<div className="grid grid-cols-[1fr,1.5fr] gap-2">
									<div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
									...
									<span className="text-gray-900 dark:text-gray-100 text-sm">{customer.phone}</span>
								</div>
								<div className="grid grid-cols-[1fr,1.5fr] gap-2">
									<div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
									...
									<span className="text-gray-900 dark:text-gray-100 text-sm">{customer.billingAddress}</span>
								</div>
							</div>
						</div>
							...
							<div>
								...
								<div className="space-y-4">
									<div className="grid grid-cols-[1fr,1.5fr] gap-2">
										...
										<span className="text-gray-900 dark:text-gray-100 text-sm capitalize">{payment.brand} {payment.last4 ? `•••• ${payment.last4}` : ""}</span>
									</div>
                                    {payment.type && (
                                        <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                            <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
                                            ...
                                            <span className="text-gray-900 dark:text-gray-100 text-sm capitalize">{payment.type}</span>
                                        </div>
                                    )}
                                    {payment.network && (
                                        <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                            ...
                                            <span className="text-gray-900 dark:text-gray-100 text-sm capitalize">{payment.network}</span>
                                        </div>
                                    )}
									<div className="grid grid-cols-[1fr,1.5fr] gap-2">
										<div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
										...
										<span className="text-gray-900 dark:text-gray-100 text-sm capitalize">{payment.funding}</span>
									</div>
                                    {payment.amountAuthorized && (
                                        <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                            ...
                                            <span className="text-gray-900 dark:text-gray-100 text-sm">{(payment.amountAuthorized / 100).toFixed(2)}</span>
                                        </div>
                                    )}
                                    {/* {payment.authorizationCode && (
                                        <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                            ...
                                            <span className="text-gray-900 dark:text-gray-100 text-sm">{payment.authorizationCode}</span>
                                        </div>
                                    )} */}
									<div className="grid grid-cols-[1fr,1.5fr] gap-2">
										<div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
										...
										<span className="text-gray-900 dark:text-gray-100 text-sm">{payment.country}</span>
									</div>
                                    {payment.fingerprint && (
                                        <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                            <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
                                            ...
                                            <span className="text-gray-900 dark:text-gray-100 text-xs text-gray-500 dark:text-gray-400 break-all">{payment.fingerprint}</span>
                                        </div>
                                    )}
									<div className="grid grid-cols-[1fr,1.5fr] gap-2">
										<div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
									...
									<div className="grid grid-cols-[1fr,1.5fr] gap-2">
										...
										<span className="text-gray-900 dark:text-gray-100 text-sm capitalize">{payment.threeDSecure || "-"}</span>
									</div>
                                    {payment.wallet && (
                                        <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                            <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm font-medium">
                                            ...
                                            <span className="text-gray-900 dark:text-gray-100 text-sm capitalize">{payment.wallet}</span>
                                        </div>
                                    )}
                                    {payment.networkTransactionId && (
                                        <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                            ...
                                            <span className="text-gray-900 dark:text-gray-100 text-xs text-gray-500 dark:text-gray-400 break-all">{payment.networkTransactionId}</span>
                                        </div>
                                    )}
								</div>
							</div>
							...
							<div className="space-y-4">
                                {checkout.ip && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.ip}</span>
                                    </div>
                                )}
                                {checkout.hostname && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.hostname}</span>
                                    </div>
                                )}
                                {checkout.city && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.city}</span>
                                    </div>
                                )}
                                {checkout.region && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.region}</span>
                                    </div>
                                )}
                                {checkout.country && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.country}</span>
                                    </div>
                                )}
                                {checkout.postal && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.postal}</span>
                                    </div>
                                )}
                                {checkout.loc && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.loc}</span>
                                    </div>
                                )}
                                {checkout.org && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.org}</span>
                                    </div>
                                )}
                                {checkout.timezone && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.timezone}</span>
                                    </div>
                                )}
                                {checkout.vpn && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.vpn}</span>
                                    </div>
                                )}
                                {checkout.proxy && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-sm">{checkout.proxy}</span>
                                    </div>
                                )}
                                {checkout.userAgent && (
                                    <div className="grid grid-cols-[1fr,1.5fr] gap-2">
                                        ...
                                        <span className="text-gray-900 dark:text-gray-100 text-xs text-gray-500 dark:text-gray-400 break-words leading-tight">{checkout.userAgent}</span>
                                    </div>
                                )}
							</div>
						</div>
