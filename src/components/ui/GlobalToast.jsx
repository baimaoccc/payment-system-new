...
function ToastItem({ item, onClose }) {
	...
	const bg = type === "error" ? "bg-action-red-30" : type === "success" ? "bg-action-green-30" : type === "warning" ? "bg-action-yellow-30" : type === "info" ? "bg-action-yellow-30" : "bg-white dark:bg-gray-800";
	...
	return (
		<div className={`rounded-md px-3 py-2 shadow-lg border ${bg} text-gray-900 dark:text-gray-100 text-xs font-normal z-[1000001]`}>
