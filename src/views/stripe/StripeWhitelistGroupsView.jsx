		...
		<div className="p-6">
			...
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700/50">
				<div>
					...
					<p className="text-gray-500 dark:text-gray-400 text-sm mt-0.5">{t("whitelistGroupsSub")}</p>
				</div>
						...
						<div className="px-8 py-6 border-b border-gray-100 dark:border-gray-700/50 bg-white dark:bg-gray-800">
							<div className="flex justify-between items-start">
								<div>
									...
									{/* <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t("createGroupSub") || "Create a new country whitelist group"}</p> */}
									{/* Info Box */}
									<div className="mt-2 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-100 dark:border-blue-800/50 text-sm text-blue-700 dark:text-blue-300 flex gap-3 items-start">
										...
										<div>
											...
											<p className="text-blue-800/90 dark:text-blue-200/90 mt-1">{t("aboutWhitelistGroupsDesc") || "白名单分组允许您定义允许进行交易的国家/地区集合。这些分组可以分配给多个 Stripe 账户，以有效管理风险。"}</p>
										</div>
									</div>
								</div>
