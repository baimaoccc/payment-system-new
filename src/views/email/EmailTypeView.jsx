				...
				<div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
					<div className="flex items-center gap-4">
						...
						<div>
							...
							<p className="text-sm text-gray-500">{t("emailTypeManagementDesc")}</p>
						</div>
					</div>
					<button
						onClick={() => {
						...
						className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30 flex items-center gap-2">
													...
													<div className="group relative cursor-pointer hover:bg-blue-50/50 p-1 rounded transition-colors -ml-1" onClick={() => handleCopy(item.order_variable)} title={t("clickToCopy")}>
														<div className="text-[10px] text-gray-400 font-medium uppercase tracking-wider mb-0.5 flex items-center gap-1">
															...
															<span className="opacity-0 group-hover:opacity-100 transition-opacity text-blue-500">
																<FontAwesomeIcon icon={faPen} className="text-[8px]" /> {/* Reusing pen icon as copy indicator if needed, or just text */}
															</span>
														</div>
